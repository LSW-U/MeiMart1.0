...
| P2 | a11y 覆盖率低 | 🔶 第一批 `9a198ea`（UI 库 5 组件）+ 第二批（核心路径 6 文件 10 Pressable：task详情/pickup/sign/navigate/ongoing/tasks）完工；剩 ~32 页面级 Pressable（login/profile/notifications 等）+ AppIcon ~86 调用方未传 label |
