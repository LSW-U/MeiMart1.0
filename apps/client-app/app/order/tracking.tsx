...
// 原因：红底白字 dark 不变（Header 3 icon/done dot/Contact Seller btn/rider dot 都是 colors.primary 红底白字，与 P10 ON_PRIMARY const 模式一致）
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Map 占位区（方案 A 装饰性街道网 — P11-物流追踪页-优化原型.html L404-425 还原） */}
        <MapPlaceholder riderLocation={riderLocation} estimatedArrival={estimatedArrival} />
...
// 地图占位（方案 A 装饰性街道网 — 还原自 P11-物流追踪页-优化原型.html L404-425）
// Why: 装饰性优先（用户决策 2026-08-07），匹配 HTML 原型 fixed % 位置，不做 lat/lng→坐标映射。
// 街道棕色调用 colors.outline（#8d706c = HTML rgba(141,112,108)）+ opacity 0.15/0.28。
  ...
  return (
    ...
    >
      ...
      >
        ...
        <View style={[styles.routePinEnd, { backgroundColor: colors.primary, borderColor: '#ffffff' }]} />
      </View>
